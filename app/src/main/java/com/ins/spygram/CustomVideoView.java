...
public class CustomVideoView extends VideoView {
    ...
    public CustomVideoView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray attributes = context.getTheme().obtainStyledAttributes(attrs, R.styleable.CustomVideoView, 0, 0);
        mScaleType = attributes.getInt(R.styleable.CustomVideoView_scaleType, SCALE_TYPE_NORMAL);
    }
